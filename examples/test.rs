...
fn main() {
    ...
    let db = DB::open::<MyOpenOptions<{ 20  * 1024 * 1024 * 1024 }>, _>(Arc::new(FakeMMap), path).unwrap(); // TODO: error handling
    {
        ...
        #[cfg(feature = "write1")]
        {
            ...
            println!("throughput:{:?}MB/s",FILE_SIZE as f64 /1024.0 /1024.0/ end.duration_since(start_time).unwrap().as_secs_f64());
        }
